...
function CalendarIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M6 5H18C19.1 5 20 5.9 20 7V19C20 20.1 19.1 21 18 21H6C4.9 21 4 20.1 4 19V7C4 5.9 4.9 5 6 5Z" stroke="currentColor" strokeWidth="2" />
      <path d="M8 3V7M16 3V7M4 10H20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M8 14H10M12 14H14M16 14H18M8 17H10M12 17H14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
